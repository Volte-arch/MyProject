    ...
    <div class="main-setting">
        <div class="setting">
            ...
            <div class="Veryfication-account">
                <h2>Pozostały czas werfikacji konta: --</h5>
                <h3><?php echo $_SESSION['User_email']?> <input type="button" value="wyśli ponownie"></h3>
            </div>
            ...
            <div class="Edit-Nickname">
                ...
                <h3><?php echo $_SESSION['Username']?> (Klikni)</h3>
            </div>

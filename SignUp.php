...
use MongoDB\Client;
    ...
    echo $GenerateSignUp;
        ...
        try{
            ...
            $passwordConfirm = $received_data['repeatPassword'];
            ...
            if(!empty($Error)){
                ...
                $Sql = "INSERT INTO user_reg (`RId`,`Nickname`, `Email`, `Password`, `AcceptTerms`, `Date_Created`) VALUES (:rid,:nick,:email,:upass,:AcceptTerms,:adate)";

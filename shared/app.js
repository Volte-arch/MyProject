    ...
    React.useEffect(() => {
        ...
        if (getUrl) {
            fetch('infofile.php', {
                ...
                .then((getdata) =>{
                    if(getdata.Answer){
                        setError(getdata.Answer);
                        setData(null);
                    }else{
                        setData(getdata.file.fileattach);
                        setError(null);
                    }
                } 
            )
                .catch(() => setError("brak informacji"));
        } else {
            ...
            <div className="video-of-users">
                                <div className="video-of-elements">
                                    <div className="toelements">
                                        ...
                                        <i className="fa-solid fa-volume-low"  style={{ color: "#ffffff" }}></i>
                                        </div>
                                        <div className="element-to-video">
                                            <div className="control-video">
                                                ...
                                                <div className="control-down">
                                                    <div className="volume-set">
                                                        ...
                                                        <input type="range" className="valume" min="0" max="100" value="0"></input>
                                                    </div>
                                            ...
                                            <video type="video/mp4" src={"../source/"+data}></video>
                                        </div>
                                    </div>
                                </div>
